...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, DIO1_Pin|DIO2_Pin|DIO3_Pin|DIO4_Pin
                          |DIO5_Pin|DIO6_Pin|DIO7_Pin|DIO8_Pin
                          |iATN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPIB_EN_Pin GPIB_DIR_Pin */
  ...
  /*Configure GPIO pins : EOI_SENSE_Pin DAV_SENSE_Pin SRQ_SENSE_Pin NDAC_SENSE_Pin */
  GPIO_InitStruct.Pin = EOI_SENSE_Pin|DAV_SENSE_Pin|SRQ_SENSE_Pin|NDAC_SENSE_Pin;
  ...
  /*Configure GPIO pin : NRFD_SENSE_Pin */
  GPIO_InitStruct.Pin = NRFD_SENSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(NRFD_SENSE_GPIO_Port, &GPIO_InitStruct);
