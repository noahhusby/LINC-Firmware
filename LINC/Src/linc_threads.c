...
#define LINC_STATUS_LED_PRIORITY 2
...
{
    const UINT status = tx_thread_create(&linc_status_led_thread, "LINC Status LED", linc_status_led_thread_entry,
                                         0x1234, linc_status_led_stack, LINC_STATUS_LED_STACK_SIZE,
